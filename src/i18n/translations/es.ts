...
export const es = {
  translation: {
    ...
    pricing: {
      ...
      guarantee: "Garantía de 30 días - Satisfacción garantizada o te devolvemos tu dinero",
    ...
    messageGenerator: {
      ...
      subtitle: "Crea respuestas profesionales para WhatsApp usando inteligencia artificial",
      messagesUsed: "Mensajes usados",
      limitReached: "Límite alcanzado",
      limitWarning: "Has alcanzado el límite de {{limit}} mensajes de tu plan",
      messageTone: "Tono del Mensaje",
      messageType: "Tipo de Mensaje",
      examples: "Ejemplos",
      clientMessage: "Mensaje del Cliente",
      clientMessagePlaceholder: "Escribe aquí el mensaje del cliente para generar una respuesta profesional...",
      ...
      responseAppearHere: "Tu respuesta aparecerá aquí",
      insertClientMessage: "Inserta el mensaje del cliente arriba",
      upgradeProTitle: "¡Actualiza al Plan Pro!",
      upgradeProDescription: "Genera mensajes ilimitadas y accede a más tonos y tipos de respuesta",
      tipsTitle: "Consejos para mejores resultados",
      tipsList: [
        "• Sé específico en tu mensaje",
        "• Usa el tono apropiado para tu negocio",
      ...
      exampleMessages: [
        ...
        "¿Tienen descuento por cantidad?",
        "¿Cómo funciona la garantía?"
      ]
    },
    metricsPage: {
      title: "Métricas y Análisis",
      subtitle: "Panel de control con datos en tiempo real de tus agentes",
      totalMessages: "Total de Mensajes",
      ...
      noPerformanceData: "Sin datos de rendimiento disponibles",
      performanceDataNote: "Los datos aparecerán cuando tus agentes procesen mensajes",
